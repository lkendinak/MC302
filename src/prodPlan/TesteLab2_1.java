...
public class TesteLab2_1 {
	...
	/**
	 * Escreve na saida padrao o conteudo de um vetor de objetos Parte devidamente convertidos 
	 * para String.
	 ...
	 * @param partes vetor de objetos Parte a partir do qual serao criados os objetos Item que formar�o o vetor
	...
	/**
	 * Escreve na saida padrao o conteudo de um vetor de objetos Item, devidamente convertidos 
	 * para String.
